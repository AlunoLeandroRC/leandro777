...
<head>
    ...
    <title>Meu Projeto</title>![image](https://github.com/user-attachments/assets/c352c6da-e8f5-4a1b-afee-b72d78631339)
...
<body>()
    ...
    <footer class="container py-5">
        ...
        <p class="my-5 text-center">© Copyright 2024. Produzido por Leandro </p>
    </footer>
